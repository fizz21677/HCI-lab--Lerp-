...
...Features:
-Smooth Cursor Movement: A circle follows the mouse with a soft, easing effect using LERP.
-Bounded Interaction Area: Movement is limited within a defined visual box.
-Vanilla JavaScript: Built using pure HTML5 Canvas with no external libraries.
 Setup

Open the index.html file in your browser to run the demo.
